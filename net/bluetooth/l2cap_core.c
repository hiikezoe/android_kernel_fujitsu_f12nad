...
/* FUJITSU:2012-05-28 WLAN/BT 1968 start */
//#define CHA_CERTIFICATION_ON
/* FUJITSU:2012-05-28 WLAN/BT 1968 end */
...
{
/* FUJITSU:2012-05-29 WLAN/BT 1978 start */
#if 0
	write_lock_bh(&chan_list_lock);
	...
	if (!atomic_read(&chan->refcnt)) {
 	...
 	chan_put(chan);
	write_unlock(&chan_list_lock);
/* FUJITSU:2012-05-29 WLAN/BT 1978 end */
}
...
#if 0 /* FUJITSU:2012-03-23 WLAN/BT Delete start (ACURA ) */
...
#endif /* FUJITSU:2012-03-23 WLAN/BT Delete end (ACURA ) */
...
/* FUJITSU:2012-05-17 WLAN/BT 0793(12-1gen) modification start */
/* FUJITSU:2012-05-28 WLAN/BT 1968 start */
#ifndef CHA_CERTIFICATION_ON
/* FUJITSU:2012-05-28 WLAN/BT 1968 end */
...
#else
		if (chan->sdu_len > chan->imtu){
			chan->sdu_len = chan->imtu;
			skb->len = chan->imtu;
			chan->sdu = bt_skb_alloc(chan->sdu_len, GFP_ATOMIC);
			skb_pull(skb, 2);
			memcpy(skb_put(chan->sdu, skb->len), skb->data, skb->len);

			err = sock_queue_rcv_skb(chan->sk, chan->sdu);
...
#endif
/* FUJITSU:2012-05-17 WLAN/BT 0793(12-1gen) modification end*/
