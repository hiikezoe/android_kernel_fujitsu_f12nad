...
//#undef BT_DBG
//#define BT_DBG(fmt, arg...) printk(KERN_ERR "blueHC %s: " fmt "\n" , __func__ , ## arg)
...
static void hci_init_req(struct hci_dev *hdev, unsigned long opt)
{
	...
	/* failsafe for init (hci command timeout occured) */
	hci_send_cmd(hdev, HCI_OP_READ_LOCAL_FEATURES, 0, NULL);
...
//Fujitsu Bluetooth Modify Start
	hci_notify(hdev, HCI_DEV_WRITE);
//Fujitsu Bluetooth Modify End
