...
/* FUJITSU:2012-03-19 modify WAKE_LOCK_IDLE start */
#include <linux/wakelock.h>
struct wake_lock yaffs2_idle_lock;
/* FUJITSU:2012-03-19 modify WAKE_LOCK_IDLE end */
...
static int __init init_yaffs_fs(void)
{
	...
	/* FUJITSU:2012-03-19 modify WAKE_LOCK_IDLE start */
	wake_lock_init(&yaffs2_idle_lock, WAKE_LOCK_IDLE, "yaffs2_scanbackwards");
	/* FUJITSU:2012-03-19 modify WAKE_LOCK_IDLE end */
...
static void __exit exit_yaffs_fs(void)
{
	...
	/* FUJITSU:2012-03-19 modify WAKE_LOCK_IDLE start */
	wake_lock_destroy(&yaffs2_idle_lock);
	/* FUJITSU:2012-03-19 modify WAKE_LOCK_IDLE end */
