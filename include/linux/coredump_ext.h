...
#define COREDUMP_SETTING_FILE  "/data/local/tmp/coredump"

#ifdef __KERNEL__
extern int get_nonvolatile(void*, unsigned long, size_t);
extern int set_nonvolatile(void*, unsigned long, size_t);
#endif
