...
/* FUJITSU:2012-4-20 add Battery start */
extern void msm_battery_health(int);
/* FUJITSU:2012-4-20 add Battery end */
/* FUJITSU:2012-05-21 disable camera key on charge holder start */
#ifdef CONFIG_MACH_F12NAD
extern int msm_get_current_chg_source(void);
#endif /* CONFIG_MACH_F12NAD */
/* FUJITSU:2012-05-21 disable camera key on charge holder end */
