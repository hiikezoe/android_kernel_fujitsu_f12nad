...
#define CFG_SET_LED         36
#define CFG_COMMAND         37
#define CFG_COMMAND_NORMAL  38
#define CFG_CAM_INT         39
#define CFG_GET_TEMP        40
#define CFG_SET_IOPORT      41
