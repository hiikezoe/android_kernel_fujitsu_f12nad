...
#define MGMT_OP_USER_PASSKEY_REPLY	0x0018
...
#define MGMT_OP_USER_PASSKEY_NEG_REPLY	0x0019
struct mgmt_cp_user_passkey_neg_reply {
	bdaddr_t bdaddr;
} __packed;

#define MGMT_OP_READ_LOCAL_OOB_DATA	0x001A
struct mgmt_rp_read_local_oob_data {
	__u8 hash[16];
	__u8 randomizer[16];
} __packed;

#define MGMT_OP_ADD_REMOTE_OOB_DATA	0x001B
...
#define MGMT_OP_REMOVE_REMOTE_OOB_DATA	0x001C
struct mgmt_cp_remove_remote_oob_data {
	bdaddr_t bdaddr;
} __packed;

#define MGMT_OP_START_DISCOVERY		0x001D

#define MGMT_OP_STOP_DISCOVERY		0x001E

#define MGMT_OP_BLOCK_DEVICE		0x001F
struct mgmt_cp_block_device {
	bdaddr_t bdaddr;
} __packed;

#define MGMT_OP_UNBLOCK_DEVICE		0x0020
struct mgmt_cp_unblock_device {
	bdaddr_t bdaddr;
} __packed;

#define MGMT_OP_SET_FAST_CONNECTABLE	0x0021
struct mgmt_cp_set_fast_connectable {
	__u8 enable;
} __packed;

#define MGMT_OP_ENCRYPT_LINK		0x0022
...
#define MGMT_OP_RESOLVE_NAME		0x0023
...
#define MGMT_OP_ADD_REMOVE_FROM_LE_WHITELIST	0x0026
struct mgmt_cp_add_remove_le_whitelist {
	__u8	add;
	struct	mgmt_addr_info addr;
} __packed;

#define MGMT_OP_CLEAR_LE_WHITELIST	0x0027

#define MGMT_OP_TOGGLE_LE_SCAN		0x0028
...
#define MGMT_OP_CANCEL_PAIR_DEVICE	0x0030
