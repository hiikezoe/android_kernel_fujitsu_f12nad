...
===========================================================================*/
int camsensor_gpioi2c_front_write(struct CameraSensorI2CCmdType *pI2CCmd)
{
    int rc = TRUE;
    uint16_t len;
    uint8_t  *pd;
...
/*===========================================================================
    FUNCTION      CAMSENSOR_GPIOI2C_FRONT_READ
===========================================================================*/
int camsensor_gpioi2c_front_read(struct CameraSensorI2CCmdType *pI2CCmd)
{
    int rc = TRUE;
    uint16_t len;
    uint8_t  *pd;
...
===========================================================================*/
int camsensor_gpioi2c_front_write_isp(struct CameraSensorI2CCmdTypeIsp *pI2CCmd)
{
    int rc = TRUE;
    uint16_t len;
    uint8_t  *pd;
...
===========================================================================*/
int camsensor_gpioi2c_front_read_isp(struct CameraSensorI2CCmdTypeIsp *pI2CCmd)
{
    int rc = TRUE;
    uint16_t len;
    uint8_t  *pd;
...
===========================================================================*/
int camsensor_i2c_front_read( struct i2c_client* client, struct CameraSensorI2CCmdTypeIsp* pI2CCmd )
{
...
/*===========================================================================
    FUNCTION      CAMSENSOR_GPIOI2C_WRITE
===========================================================================*/
int camsensor_i2c_front_write( struct i2c_client* client, struct CameraSensorI2CCmdTypeIsp* pI2CCmd )
{
...
===========================================================================*/
int camsensor_i2c_front_read_normal( struct i2c_client* client, struct CameraSensorI2CCmdType* pI2CCmd )
{
...
===========================================================================*/
int camsensor_i2c_front_write_normal( struct i2c_client* client, struct CameraSensorI2CCmdType* pI2CCmd )
{
