...
/* size of memory */
#define FTA_CONFIG_STORE_MEMORY_SIZE    0x1FFF00
...
#define FTA_TAG_PROC1_MEMORY_SIZE           (8*1024)
#define FTA_TAG_PROC2                       0x32435250          /* PRC2 */
#define FTA_TAG_PROC2_MEMORY_SIZE           (8*1024)
#define FTA_TAG_PROC3                       0x33435250          /* PRC3 */
#define FTA_TAG_PROC3_MEMORY_SIZE           (8*1024)
...
extern unsigned long fta_log_area[FTA_CONFIG_STORE_MEMORY_SIZE/4];
