 ...
 * -------------------------------- */
unsigned long fta_log_area[FTA_CONFIG_STORE_MEMORY_SIZE/4] __attribute__((section(".fta.data")));
// char *fta_log_area;
fta_manager_initializer_info fta_manager_initializer = 
  FTA_MANAGER_INITIALIZER_INFO_DEF(
    (fta_manager_store_header *)fta_log_area,
    fta_initial_config_stores,
    FTA_CONFIG_STORE_INITIAL_COUNT,
    FTA_LIB_OFFSET_ADDR(fta_log_area, FTA_CALC_MANAGER_SIZE(FTA_CONFIG_STORE_INITIAL_COUNT)),
