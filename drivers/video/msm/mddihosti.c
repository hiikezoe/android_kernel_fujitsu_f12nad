...
extern int mddi_panel_get_padcal(boolean is_hivernating);
extern int mddi_panel_get_drvcnt(boolean is_hivernating);
...
/* FUJITSU:2012-02-27 DISP MDPreg customize start */
#if 1
			mddi_host_reg_out(PAD_CAL, mddi_panel_get_padcal(TRUE));
			mddi_host_reg_out(DRIVER_START_CNT, mddi_panel_get_drvcnt(TRUE));
#else
/* FUJITSU:2011-12-22 MDDI-SwingLevel start */
			//mddi_host_reg_out(PAD_CAL, 0x10220020);
			mddi_host_reg_out(PAD_CAL, 0xf1fe0020);
			mddi_host_reg_out(DRIVER_START_CNT, 0x00800000);
/* FUJITSU:2011-12-22 MDDI-SwingLevel end */
#endif
/* FUJITSU:2012-02-27 DISP MDPreg customize end */
...
/* FUJITSU:2012-02-27 DISP MDPreg customize start */
#if 1
	pad_reg_val = mddi_panel_get_padcal(FALSE);
#else
/* FUJITSU:2011-12-22 MDDI-SwingLevel start */
	//pad_reg_val = 0x00220020;
	pad_reg_val = 0x01fe0020;
/* FUJITSU:2011-12-22 MDDI-SwingLevel end */
#endif
/* FUJITSU:2012-02-27 DISP MDPreg customize end */
...
/* FUJITSU:2012-02-27 DISP MDPreg customize start */
#if 1
	mddi_host_reg_out(DRIVER_START_CNT, mddi_panel_get_drvcnt(FALSE));
#else
/* FUJITSU:2011-12-22 mddi start cont register change start */
//	mddi_host_reg_out(DRIVER_START_CNT, 0x60006);
	mddi_host_reg_out(DRIVER_START_CNT, 0x00380000);
/* FUJITSU:2011-12-22 mddi start cont register change end */
#endif
/* FUJITSU:2012-02-27 DISP MDPreg customize end */
