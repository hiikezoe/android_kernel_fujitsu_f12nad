...
#include <mach/gpio.h> /*FUJITSU:2011-12-01*/
...
extern void samsung_disp_power_on(void);	 /*FUJITSU:2011-12-01*/
#ifdef CONFIG_FB_MSM_LCDC /* FUJITSU:2012-02-27 DISP data enable start */
extern int lcdc_panel_get_data_en_polarity(void);  
#endif                    /* FUJITSU:2012-02-27 DISP data enable end */
...
/* FUJITSU:2012-02-27 DISP data enable start */
	...
	data_en_polarity = lcdc_panel_get_data_en_polarity();
#else
/* FUJITSU:2011-12-01 change for Samsung EL --> */
//	data_en_polarity = 0;
	data_en_polarity = 1;
/* FUJITSU:2011-12-01 change for Samsung EL <-- */
#endif
...
/* FUJITSU:2011-11-15 add start */
	ret = panel_next_off(pdev);
/* FUJITSU:2011-11-15 add end */
...
/* FUJITSU:2011-11-15 del start */
//	ret = panel_next_off(pdev);
/* FUJITSU:2011-11-15 del end */
...
/* FUJITSU:2011-12-01 Lcd status check start */
#if defined(CONFIG_MACH_FJI12) || defined(CONFIG_MACH_F11APO) || defined(CONFIG_MACH_F12APON)	
extern bool get_lcd_status(void);
#endif
/* FUJITSU:2011-12-01 Lcd status check end */
