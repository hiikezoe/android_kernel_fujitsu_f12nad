...
static void dbs_refresh_callback(struct work_struct *unused)
{
	...
	/* FUJITSU:2011-04-12 add CLOCK UP err start */
	int ret = 0;
	unsigned int temp_cur = 0;
	/* FUJITSU:2011-04-12 add CLOCK UP err end */
	...
	if (policy->cur < policy->max) {
/* FUJITSU:2011-04-12 mod CLOCK UP err start */
		temp_cur = policy->cur;
/* FUJITSU:2011-04-12 mod CLOCK UP err end */
...
/* FUJITSU:2011-04-12 mod CLOCK UP err start */
		if (ret != 0){
			printk("__cpufreq_driver_target()=%d, %d, %d\n", ret, temp_cur, policy->max);
			policy->cur = temp_cur;
		}
/* FUJITSU:2011-04-12 mod CLOCK UP err end */
