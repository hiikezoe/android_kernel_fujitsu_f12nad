...
/* FUJITSU:2012-03-30 add Battery start */
	...
	POWER_SUPPLY_ATTR(rvoltage_now),
...
/* FUJITSU:2011-11-02 add Battery start */
#ifdef CONFIG_FUJITSU_MSM_TEMP
	POWER_SUPPLY_ATTR(temp_msm),
#endif //CONFIG_FUJITSU_MSM_TEMP
/* FUJITSU:2011-11-02 add Battery end */
