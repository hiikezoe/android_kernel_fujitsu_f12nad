...
#define VIBE_DEBUG   1  /* VIBE_DEBUG */
/* FUJITSU:2011-12-06  TS5K [end] */
...
/* FUJITSU:2012.03.30 TS5K[start] */
typedef struct
{
   VibeUInt8 nCycle;
   VibeUInt8 nCount;
} haptic_buffer;
/* FUJITSU:2012.03.30 TS5K[end]   */
...
/* Add by ISB on 2012.04.xx -< */
    #define IMMVIBE_I2C_ADR                     0x59  /* Slave Address */

/* 2012.06.06 chg[start]
    bool is_use_i2c                           = false; [old]
**/
    static bool is_use_i2c_tspdrv             = false; /* false:Use GPIO-i2c; true:Use Real-i2c*/
/* 2012.06.06 chg[end]   */
...
#define TSPDRV_MC_HAPTIC                    _IOW(TSPDRV_MAGIC_NUMBER & 0xFF, 6, haptic_buffer *)
