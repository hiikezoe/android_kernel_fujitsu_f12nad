...
/* FUJITSU:2011-12-01 change ecc error check start */
#if 0
					if (ecc_errors > 1)
#else
					if (ecc_errors > 4)
#endif
/* FUJITSU:2011-12-01 change ecc error check end */
						pageerr = -EUCLEAN;
				}
			}
		}
...
/* FUJITSU:2011-06-25 for FOTA ADD-E */
					...
					if (n % 2 == 0)
					{
						...
						NC01(MSM_NAND_FLASH_BUFFER)
						+ 516;
/* FUJITSU:2012-04-09 for FOTA ADD-S */
						if ( partinfo )
						{
							cmd->src = 
							NC01(MSM_NAND_FLASH_BUFFER)
...
/* FUJITSU:2012-04-09 for FOTA ADD-E */
					}
					else
					{
						cmd->src =
...
msm_nand_block_isbad(struct mtd_info *mtd, loff_t ofs)
{
	...
	unsigned page = 0;
	unsigned cwperpage;
/* FUJITSU:2011-12-01 change NAND bad block start */
    unsigned int bit_count;
    unsigned int bit_mask;
    unsigned int loop;
/* FUJITSU:2011-12-01 change NAND bad block end */
