...
/* FUJITSU:2012-03-06 modify vmalloc_user_gpu, __GFP_GPU start */
			// vmalloc_user(obj->size * priv->bufcount);
			vmalloc_user_gpu(obj->size * priv->bufcount);
/* FUJITSU:2012-03-06 modify vmalloc_user_gpu, __GFP_GPU end */
