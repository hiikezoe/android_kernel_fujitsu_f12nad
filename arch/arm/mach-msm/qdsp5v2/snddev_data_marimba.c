...
static struct snddev_virtual_data snddev_a2dp_tx_data = {
	.capability = SNDDEV_CAP_TX,
	/*.name = "a2dp_tx",   FUJITSU:2012-1-20 del */
	.name = "dummy_tx", /* FUJITSU:2012-1-20 add */
	.copp_id = 5,
	.acdb_id = PSEUDO_ACDB_ID,
};
...
static struct snddev_virtual_data snddev_a2dp_rx_data = {
	.capability = SNDDEV_CAP_RX,
	/*.name = "a2dp_rx",   FUJITSU:2012-1-20 del */
	.name = "dummy_rx", /* FUJITSU:2012-1-20 add */
	.copp_id = 2,
	.acdb_id = PSEUDO_ACDB_ID,
};
...
static struct platform_device *snd_devices_surf[] __initdata = {
	...
	&msm_bt_sco_mic_device,
	&msm_ispeaker_rx_device,
	&msm_ispeaker2_rx_device, /* FUJITSU:2012-1-20 add */
	&msm_ispeaker_tx_device,
	&msm_ihs_stereo_speaker_stereo_rx_device,
	&msm_bt_sco_ec_off_earpiece_device,
	&msm_bt_sco_ec_off_mic_device,
	&msm_ispeaker_tx_for_vrec_device,
	&msm_a2dp_rx_device, /* FUJITSU:2012-1-20 dummy device */
	&msm_a2dp_tx_device, /* FUJITSU:2012-1-20 dummy device */
};
