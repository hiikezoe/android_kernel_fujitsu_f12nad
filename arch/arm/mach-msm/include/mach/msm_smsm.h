...
#define SMEM_V1_OEM_015_SIZE		(300)
#define SMEM_V1_OEM_019_SIZE		(128)	 /* FUJITSU:2012-05-15 Add */
...
typedef struct {
	...
	unsigned char				smem_v1_oem_012;
	unsigned char				smem_v1_oem_013;
	smem_illumi_info			smem_v1_oem_014;
	unsigned char				smem_v1_oem_015[SMEM_V1_OEM_015_SIZE];
	unsigned char				smem_v1_oem_016;
	unsigned long				smem_v1_oem_017; /* FUJITSU:2012-02-08 Add */
	unsigned long				smem_v1_oem_018; /* FUJITSU:2012-03-27 add */
	unsigned char				smem_v1_oem_019[SMEM_V1_OEM_019_SIZE]; /* FUJITSU:2012-05-15 Add */
...
typedef enum
{
	...
	SMEM_OEM_015,
	SMEM_OEM_016,
	SMEM_OEM_017, /* FUJITSU:2012-02-08 Add */
	SMEM_OEM_018, /* FUJITSU:2012-03-27 add */
	SMEM_OEM_019, /* FUJITSU:2012-05-15 Add */
	SMEM_TSB_LAST_ID_V1
