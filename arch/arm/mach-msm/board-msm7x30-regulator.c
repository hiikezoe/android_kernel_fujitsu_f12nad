...
/* FUJITSU:2011-12-01  mdfy uV start */
//    PCOM_VREG_LDO(ldo10,  7, NULL,  2600000,  2600000, 0, -1, 0, 0, 0, 0),
/* FUJITSU:2012-01-23  mdfy touch start */
#if defined(CONFIG_MACH_F11APO) || defined(CONFIG_MACH_F12APON)
    PCOM_VREG_LDO(ldo10,  7, NULL,  2600000,  2900000, 0, -1, 0, 0, 0, 0),
/* FUJITSU : 2012-01-19 chg camera start */
#elif  defined(CONFIG_MACH_F09D)
	PCOM_VREG_LDO(ldo10,  7, NULL,  1500000,  1500000, 0, -1, 0, 0, 0, 0),
/* FUJITSU : 2012-01-19 chg camera end */
#else
    PCOM_VREG_LDO(ldo10,  7, NULL,  2600000,  2600000, 0, -1, 0, 0, 0, 0),
#endif
/* FUJITSU:2012-01-23  mdfy touch end */
/* FUJITSU:2011-12-01  mdfy uV end */
/* FUJITSU:2012-01-06  mdfy camera start */
#if defined(CONFIG_MACH_F11APO) || defined(CONFIG_MACH_F12APON) || defined(CONFIG_MACH_FJI12) || defined(CONFIG_MACH_F12NAD)
    PCOM_VREG_LDO(ldo11, 21, NULL,  2700000,  2700000, 0, -1, 0, 0, 0, 0),
...
#endif
/* FUJITSU:2012-01-06  mdfy camera end */
	PCOM_VREG_LDO(ldo12, 34, NULL,  1800000,  1800000, 0, -1, 0, 0, 0, 0),
/* FUJITSU : 2012-01-19 add camera start */
#if defined(CONFIG_MACH_F09D)
	PCOM_VREG_LDO(ldo13, 15, NULL,  2800000,  2800000, 0, -1, 0, 0, 0, 0),
#elif defined(CONFIG_MACH_F12NAD)
	PCOM_VREG_LDO(ldo13, 15, NULL,  2700000,  2700000, 0, -1, 0, 0, 0, 0),
#else
...
/* FUJITSU:2012-01-24 add F11EIF start */
/* FUJITSU:2011-12-22  mdfy msm_sdcc support start */
...
#elif defined(CONFIG_MACH_F11APO) || defined(CONFIG_MACH_F12APON) || defined(CONFIG_MACH_FJI12) || defined(CONFIG_MACH_F11EIF)
	PCOM_VREG_LDO(ldo15, 23, NULL,  2850000,  2850000, 0, -1, 0, 0, 0, 0),
#else
	PCOM_VREG_LDO(ldo15, 23, NULL,  3050000,  3100000, 0, -1, 0, 0, 0, 0),
#endif
/* FUJITSU:2011-12-22  mdfy msm_sdcc support end */
/* FUJITSU:2012-01-24 add F11EIF end */
/* FUJITSU:2012-06-07 mod sdcc end */
/* FUJITSU:2012-01-06  mdfy camera start */
...
/* FUJITSU : 2012-01-19 add camera */
#elif defined(CONFIG_MACH_F09D) ||  defined(CONFIG_MACH_F12NAD)
...
/* FUJITSU : 2012-01-19 chg camera start */
#if  defined(CONFIG_MACH_F09D) || defined(CONFIG_MACH_F12NAD)
...
/* FUJITSU:2012-01-06  mdfy camera start */
/* FUJITSU : 2012-01-19 add camera CONFIG_MACH_F09D */
#if defined(CONFIG_MACH_F11APO) || defined(CONFIG_MACH_F12APON) || defined(CONFIG_MACH_FJI12) || defined(CONFIG_MACH_F09D) || defined(CONFIG_MACH_F12NAD)
	PCOM_VREG_LDO(ldo23, 22, NULL,  1200000,  1200000, 0, -1, 0, 0, 0, 0),
#else
