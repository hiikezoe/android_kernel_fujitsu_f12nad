...
/* FUJITSU:2012_01_06 mod camera start */
	F_MND16(21333333, pll1, 4,   1,   9),
/* FUJITSU:2012_01_06 mod camera end */
/* FUJITSU:2012_01_19 mod camera start */
	F_MND16(24000000, pll1, 4,   1,   8),
	F_MND16(24576000, lpxo, 1,   0,   0),
/* FUJITSU:2012_01_06 mod camera end */
	F_MND16(24000000, pll1, 4,   1,   8),
/* FUJITSU:2012_05_21 mod camera start */
	F_MND16(25600000, pll1, 1,   1,   30),
/* FUJITSU:2012_05_21 mod camera end */
...
static struct clk_freq_tbl clk_tbl_spi[] = {
	F_MND8(       0,  0,  0, gnd,  1,   0,     0),
/* FUJITSU:2011-12-20 wolfson start */
	F_MND8(  400000, 19, 12, lpxo, 1,   2,  123),
	F_MND8( 1638400, 19, 12, lpxo, 1,   1,   15),
/* FUJITSU:2011-07-20 wolfson end */
	F_MND8( 9963243, 19, 12, pll3, 4,   2,    37),
	F_MND8(24576000, 19, 12, lpxo, 1,   0,     0),
	F_MND8(25896198, 19, 12, pll3, 4,  34,   242), /* FUJITSU:2011-07-20 wolfson */
