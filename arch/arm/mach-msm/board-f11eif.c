...
/* FUJITSU:2012-01-24 add F11EIF */
#if defined(CONFIG_MACH_F11SKY) || defined(CONFIG_MACH_F09D) || defined(CONFIG_MACH_F11EIF)
...
static const uint16_t cyttsp_abs[] = {
	...
	ABS_MT_TOUCH_MAJOR/*ABS_MT_PRESSURE*/, CY_ABS_MIN_P, CY_ABS_MAX_P, 0, 0,
	0/*ABS_MT_TOUCH_MAJOR*/, CY_ABS_MIN_W, CY_ABS_MAX_W, 0, 0,
...
/* FUJITSU:2011-12-22 add cyttps start */
...
/* FUJITSU:2012-01-24 del TIMPANI for f11eif start */
#if defined(CONFIG_MACH_F12APON) || defined(CONFIG_MACH_F09D)
...
#endif
/* FUJITSU:2012-01-24 del TIMPANI for f11eif end */
...
/* FUJITSU:2011-12-22 AN32155AB start */
static struct platform_device an32155ab_device = {
        .name   = "an32155ab-leds",
        .id     = -1,
};
/* FUJITSU:2011-12-22 AN32155AB end */
...
static int display_common_power(int on)
{
    ...
    if (on) {
        ...
        if(!backlight_init){
            ...
            buffer[0] = 0x01;
            buffer[1] = 0x1E;	/* FUJITSU:2011-08-12 0x0E -> 0x1E */
            ret = i2c_transfer(i2c_lcd, &msg, 1);
            if(ret < 0){
...
/* FUJITSU:2012-01-24 delete start */
#if defined(CONFIG_MACH_F12APON) || defined(CONFIG_MACH_F09D)
	.mdp_rev = MDP_REV_40,
#endif
/* FUJITSU:2012-01-24 delete end */
};
...
/* FUJITSU:2012-01-24 start */
#if defined(CONFIG_MACH_F12APON) || defined(CONFIG_MACH_F11EIF)
...
#endif
/* FUJITSU:2011-12-22 mod SDCard start */
#if 0
    ...
    {GPIO_CFG(168,0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL  , GPIO_CFG_2MA), "SD_RST" },
    {GPIO_CFG(169,0, GPIO_CFG_INPUT , GPIO_CFG_NO_PULL  , GPIO_CFG_2MA), "SD_INT" },
    {GPIO_CFG(171,0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL  , GPIO_CFG_2MA), "SD_CLK_EN" },
#endif
/* FUJITSU:2011-12-22 mod SDCard end */
/* FUJITSU:2012-01-24 delete end */
};
...
#endif
#ifdef CONFIG_MMC_MSM_SDC4_SUPPORT
/* FUJITSU:2012-01-24 mmc start */
#if defined(CONFIG_MACH_F12APON) || defined(CONFIG_MACH_F11EIF)
	if (mmc_regulator_init(4, "gp6", 2850000))
#else
	if (mmc_regulator_init(4, "mmc", 2850000))
#endif
/* FUJITSU:2012-01-24 mmc end */
		return;
...
/* FUJITSU:2012-01-24 add hardware start */
...
MACHINE_END
/* FUJITSU:2012-01-24 add hardware end */
