...
void *smem_alloc_vendor1(smem_mem_vendor1_type smem_v1_type)
{
	...
	case SMEM_OEM_012:
	    ...
	    break;
	case SMEM_OEM_013:
		ret_ptr = &(smem_ptr->smem_v1_oem_013);
	    break;
	case SMEM_OEM_014:
		ret_ptr = &(smem_ptr->smem_v1_oem_014);
	    break;
	case SMEM_OEM_015:
		ret_ptr = &(smem_ptr->smem_v1_oem_015);
	    break;
	case SMEM_OEM_016:
		ret_ptr = &(smem_ptr->smem_v1_oem_016);
	    break;
/* FUJITSU:2012-02-08 Add start */
	case SMEM_OEM_017:
		ret_ptr = &(smem_ptr->smem_v1_oem_017);
	    break;
/* FUJITSU:2012-02-08 Add end */
/* FUJITSU:2012-03-27 add start */
	case SMEM_OEM_018:
		ret_ptr = &(smem_ptr->smem_v1_oem_018);
	    break;
/* FUJITSU:2012-03-27 add end */
/* FUJITSU:2012-05-15 Add start */
	case SMEM_OEM_019:
		ret_ptr = &(smem_ptr->smem_v1_oem_019[0]);
	    break;
/* FUJITSU:2012-05-15 Add end */
	default:
	    /* DO NOTHING */
	    break;
	}
