...
#if defined(CONFIG_MACH_F11SKY) || defined(CONFIG_MACH_F12ACE)
...
#if defined(CONFIG_M6MORL_IMX046ES) || defined(CONFIG_S5K6AAFX13)
...
#endif
	.avail_chg_sources   	= AC_CHG | USB_CHG | WIRELESS_CHG,
