...
/* FUJITSU:2012-02-13 mod mxt start */
//#include <linux/i2c/atmel_mxt_ts_apo.h>
#include "board-touch-fj.c"
/* FUJITSU:2012-02-13 mod mxt end */
...
#endif
/* FUJITSU:2012_01_06 add camera start */
#if defined(CONFIG_IUS006F2)
	{
		I2C_BOARD_INFO("ius006f2", 0x3C),
	},
#endif
/* FUJITSU:2012_01_06 add camera end */
};
...
/* FUJITSU:2012_01_06 add camera start */
#ifdef CONFIG_IUS006F2
struct msm_camera_device_platform_data msm_camera_device_ius006f2_data = {
	.camera_gpio_on  = config_camera_on_gpios,
	.camera_gpio_off = config_camera_off_gpios,
	.ioext.camifpadphy = 0xAB000000,
	.ioext.camifpadsz  = 0x00000400,
...
/* FUJITSU:2012_01_06 add camera start */
#ifdef CONFIG_IUS006F2
static struct msm_camera_sensor_flash_data flash_ius006f2 = {
//	.flash_type = MSM_CAMERA_FLASH_LED,
	.flash_type = MSM_CAMERA_FLASH_NONE,
	.flash_src  = &msm_flash_src_pwm
};

static struct msm_camera_sensor_info msm_camera_sensor_ius006f2_data = {
	.sensor_name    = "ius006f2",
	.sensor_reset   = 0,
	.sensor_pwd     = 85,
	.vcm_pwd        = 1,
	.vcm_enable     = 1,
	.pdata          = &msm_camera_device_ius006f2_data,
	.resource       = msm_camera_resources,
	.num_resources  = ARRAY_SIZE(msm_camera_resources),
	.flash_data     = &flash_ius006f2,
	.csi_if         = 1
};

static struct platform_device msm_camera_sensor_ius006f2 = {
	.name      = "msm_camera_ius006f2",
	.dev       = {
		.platform_data = &msm_camera_sensor_ius006f2_data,
	},
};
#endif
/* FUJITSU:2012_01_06 add camera end */
...
#else
	gpio_tlmm_config( GPIO_CFG(148, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA), GPIO_CFG_ENABLE );
	gpio_set_value(148,1);
#endif
...
#else
	gpio_set_value(148,0);
	gpio_tlmm_config( GPIO_CFG(148, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE );
#endif
/* FUJITSU:2011-12-01 speaker amp end */
...
/* FUJITSU:2011-12-01 add SPI devices start */
#if 1
static struct spi_board_info lcdc_samsung_spi_board_info[] __initdata = {
/* FUJITSU:2011-09-05 add WAVEIF start */
	{
...
/* FUJITSU:2011-09-05 add WAVEIF end */
	{
		.modalias       = "lcdc_samsung_ams367pe02",//"lcdc_toshiba_ltm030dd40", #ifdef CONFIG_VARIANT_FJORD change
		.mode           =  SPI_MODE_3,//SPI_MODE_3|SPI_CS_HIGH, #ifdef CONFIG_VARIANT_FJORD change
		.bus_num        = 0,
		.chip_select    = 1,//0,#ifdef CONFIG_VARIANT_FJORD change
...
#endif
#endif
/* FUJITSU:2011-12-01 add SPI devices end */
...
#else
	{ GPIO_CFG(44, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA), "spi_cs1" },//#ifdef CONFIG_VARIANT_FJORD change add
 ...
 * the future.
 */
/* FUJITSU:2012-02-17 DISP mod start */
	{ GPIO_CFG(18, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_grn0" },
	{ GPIO_CFG(19, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_grn1" },
	{ GPIO_CFG(20, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_blu0" },
	{ GPIO_CFG(21, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_blu1" },
	{ GPIO_CFG(22, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_blu2" },
	{ GPIO_CFG(23, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_red0" },
	{ GPIO_CFG(24, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_red1" },
	{ GPIO_CFG(25, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_red2" },
/* FUJITSU:2012-02-17 DISP mod end */
#ifndef CONFIG_SPI_QSD
	{ GPIO_CFG(45, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "spi_clk" },
	{ GPIO_CFG(46, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "spi_cs0" },
	{ GPIO_CFG(47, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "spi_mosi" },
...
/* FUJITSU:2012-02-17 DISP mod start */
	...
	{ GPIO_CFG(94, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_grn2" },
	{ GPIO_CFG(95, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_grn3" },
	{ GPIO_CFG(96, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_grn4" },
	{ GPIO_CFG(97, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_grn5" },
	{ GPIO_CFG(98, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_grn6" },
	{ GPIO_CFG(99, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_grn7" },
	{ GPIO_CFG(100, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_blu3" },
	{ GPIO_CFG(101, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_blu4" },
	{ GPIO_CFG(102, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_blu5" },
	{ GPIO_CFG(103, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_blu6" },
	{ GPIO_CFG(104, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_blu7" },
	{ GPIO_CFG(105, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_red3" },
	{ GPIO_CFG(106, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_red4" },
	{ GPIO_CFG(107, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_red5" },
	{ GPIO_CFG(108, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_red6" },
	{ GPIO_CFG(109, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "lcdc_red7" },
/* FUJITSU:2012-02-17 DISP mod end */
};
...
/* FUJITSU:2011-12-01 del display power start */
#if 0
...
#endif
/* FUJITSU:2011-12-01 display power end */
	if (on) {
...
/* FUJITSU:2011-12-01 del lcd GPIO end */
#if 0
			/* ouput low */
...
/* FUJITSU:2011-12-01 invert mdp_lcdc_pclk signal start */	
#define MDP_LCDC_NS_REG		(MSM_CLK_CTL_SH2_BASE + (0x0390))
/* FUJITSU:2011-12-01 invert mdp_lcdc_pclk signal end */
...
/* FUJITSU:2011-12-01 del quickvx start */
#if 0
		quickvx_mddi_client = 0;
#endif
/* FUJITSU:2011-12-01 del quickvx start */
...
/* FUJITSU:2011-12-01 invert mdp_lcdc_pclk signal start */	
	val = readl(MDP_LCDC_NS_REG);
	val = val | 0x00000400;	//	bit10:MDP_LCDC_PCLK_INV
	writel(val,MDP_LCDC_NS_REG);
/* FUJITSU:2011-12-01 invert mdp_lcdc_pclk signal end */
...
#else  // Fujitsu 2011.07.29 WLAN/BT change
			bcm43xx_gpio_set_value(149, on); /* KO_WLAN_BT_PWR_ONOFF */
#endif // Fujitsu 2011.07.29 WLAN/BT change end
			msleep(1);
#if 0  // Fujitsu 2011.07.29 WLAN/BT change start
			gpio_set_value(21, on); /* KO_BT_WAKEUP 		*/
#else  // Fujitsu 2011.07.29 WLAN/BT change
			bcm43xx_gpio_set_value(150, on); /* KO_BT_WAKEUP 		*/
#endif // Fujitsu 2011.07.29 WLAN/BT change end
...
int pin,rc;
		...
		// GPIO REQUEST
		rc = bcm43xx_gpio_request(149, "KO_WLAN_BT_PWR_ONOFF");// Fujitsu 2011.07.29 WLAN/BT change
		if (rc) {
...
// 2011.08.15 WLAN/BT del end
	...
	bcm43xx_gpio_direction_output(149, 0);		// WLAN_BT_PWR_ONOFF(OUT,Low)
// 2011.08.15 WLAN/BT del start
...
// 2011.08.15 WLAN/BT del end
	bcm43xx_gpio_direction_input(145);			// WLAN_HOSTWAKEUP(IN)
...
/* FUJITSU:2011-12-01 mod i2c gpio16/17 -> gpio0/1 start */
static struct msm_gpio qup_i2c_gpios_io[] = {
	{ GPIO_CFG(0, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "qup_scl" },
	{ GPIO_CFG(1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "qup_sda" },
};

static struct msm_gpio qup_i2c_gpios_hw[] = {
	{ GPIO_CFG(0, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "qup_scl" },
	{ GPIO_CFG(1, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "qup_sda" },
};
/* FUJITSU:2011-12-01 mod i2c gpio16/17 -> gpio0/1 end */
...
/* FUJITSU:2011-12-01 mod SDCard start */
#if 0
...
#else
	{GPIO_CFG(58, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA), "sdc4_clk"},
	{GPIO_CFG(59, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA), "sdc4_cmd"},
	{GPIO_CFG(60, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA), "sdc4_dat_3"},
	{GPIO_CFG(61, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA), "sdc4_dat_2"},
	{GPIO_CFG(62, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA), "sdc4_dat_1"},
	{GPIO_CFG(63, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA), "sdc4_dat_0"},
#endif
/* FUJITSU:2011-12-01 mod SDCard end */
};
...
#endif
#ifdef CONFIG_MMC_MSM_SDC4_SUPPORT
/* FUJITSU:2011-11-14 mod SDCard start */
#if 0
...
{
/* FUJITSU:2011-12-1 mod LED start */
#if 0
	if (machine_is_msm7x30_surf())
#else
    if (machine_is_f12apon()) {
        pm8058_7x30_data.leds_pdata = &pm8058_leds_data;
	} else if (machine_is_msm7x30_surf())
#endif
/* FUJITSU:2011-12-1 mod LED end */
...
/* FUJITSU:2011-12-01 add audio gpio start */
	gpio_tlmm_config( GPIO_CFG(148, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE );
	gpio_tlmm_config( GPIO_CFG(127, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE );
	gpio_set_value(127,0);
/* FUJITSU:2011-12-01 add audio gpio end */
/* FUJITSU:2011-12-01 add keypad gpio start */
...
/* FUJITSU:2011-12-01 add keypad gpio end */

	i2c_register_board_info(0, msm_i2c_board_info,
			ARRAY_SIZE(msm_i2c_board_info));

/* FUJITSU:2011-12-01 touchscreen start */
    i2c_register_board_info( 4, mxt_info, ARRAY_SIZE(mxt_info) );
/* FUJITSU:2011-12-01 taouchscreen end */
...
/* FUJITSU:2011-12-1 add hardware start */
MACHINE_START(F12APON, "F12APON")
...
MACHINE_END
/* FUJITSU:2011-12-1 add hardware end */
