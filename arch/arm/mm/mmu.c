...
/* FUJITSU:2012-01-30 add RAM 1G start */
#if defined(CONFIG_ARCH_MSM7X30)
unsigned long membank2_size;
EXPORT_SYMBOL(membank2_size);
#define EBI0_SIZE_256 0x10000000
#define EBI0_SIZE_512 0x20000000
#endif
/* FUJITSU:2012-01-30 add RAM 1G end */
...
/* FUJITSU:2012-01-30 add RAM 1G start */
#if defined(CONFIG_ARCH_MSM7X30)
    membank2_size = EBI0_SIZE_256;
    for (i = 0; i < meminfo.nr_banks; i++) {
        if(meminfo.bank[i].size > EBI0_SIZE_256){
            membank2_size = EBI0_SIZE_512;
            break;
        }
    }
    printk(KERN_NOTICE "membank size = 0x%lx\n", (unsigned long)membank2_size);
#endif
/* FUJITSU:2012-01-30 add RAM 1G end */
